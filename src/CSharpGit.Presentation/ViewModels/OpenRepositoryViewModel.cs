...
public sealed partial class OpenRepositoryViewModel : INotifyPropertyChanged
{
    ...
    public OpenRepositoryViewModel(IFolderPicker folderPicker, IRepositoryService repositoryService, IHistoryService historyService, IRepositoryStateService stateService, IWorkingTreeService workingTreeService, IReferenceService referenceService, IRepositorySyncService syncService, IRepositoryWorkflowService workflowService, IGitToolsService gitToolsService, ILogger<OpenRepositoryViewModel> logger, IRepositoryRefreshProbe? refreshProbe = null)
    {
