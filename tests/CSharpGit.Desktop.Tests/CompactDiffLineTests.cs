...
public sealed class CompactDiffLineTests
{
    ...
    public void RemovesNoiseHeadersAndCalculatesOldAndNewLineNumbers()
    {
        ...
        Assert.Equal<int?>(10, lines[1].OldLineNumber);
        Assert.Equal<int?>(10, lines[1].NewLineNumber);
        Assert.Equal<int?>(11, lines[2].OldLineNumber);
        Assert.Null(lines[2].NewLineNumber);
        Assert.Null(lines[3].OldLineNumber);
        Assert.Equal<int?>(11, lines[3].NewLineNumber);
        Assert.Equal<int?>(12, lines[4].OldLineNumber);
        Assert.Equal<int?>(12, lines[4].NewLineNumber);
        Assert.Null(lines[5].OldLineNumber);
        Assert.Equal<int?>(13, lines[5].NewLineNumber);
